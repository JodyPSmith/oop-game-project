...
// Preload game images
var images = {};
['rylee.png', 'stars.png', 'ryder.png', 'theo.png'].forEach(imgName => {
    var img = document.createElement('img');
    img.src = 'images/TerrorKids/' + imgName;
    images[imgName] = img;
});
